                    ...
                    <li>
                        <div class="comment-main-level">
                            ...
                            <div class="comment-box">
                                <div class="comment-head">
                                    <h6 class="comment-name by-author"><a href="{{route('profile.index')}}">{{$comment->user->name}}</a></h6>
                        ...
                        <ul class="comments-list reply-list">
                            <li>
                                ...
                                <div class="comment-box">
                                    <div class="comment-head">
                                        <h6 class="comment-name"><a href="{{route('profile.index')}}">{{$reply->user->name}}</a></h6>
